...
echo '  <div class="panel panel-default">
            <div class="panel-body">
                Now the <b>$person</b> var got all the data, check the <a href="https://duyplus.github.io/tmdbapi/class-Person.html">documentation</a> for the complete list of methods.<br><br>
                <b>' . $person->getName() . '</b>
                <ul>
